...
export class ItemCard extends Component<HTMLElement, Element, ProjectView> {
    ...
    private itemHTML(item: {
        ...
        if (shouldBeTruncated) {
            ...
            truncatedHTML = html`
                <p class="item-description collapsible full-item-description">
                    ${item.description}
                </p>
                ...
                <div class="item-card draggable">
                    ...
                    <div class="item-card-footer">
                        <div class="item-options">
                            <button
                                type="button"
                                class="item-btn edit-item-btn item-option-spacing"
                            >
                                <svg
                                    class="item-icon"
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            <button
                                type="button"
                                class="item-btn delete-item-btn"
                            >
                                <svg
                                    class="item-icon"
                                    xmlns="http://www.w3.org/2000/svg"
    ...
    configure() {
        ...
        itemDeleteBtn?.addEventListener(
            "click",
            this.deleteBtnClick.bind(this)
        );
    ...
    edit(title: string, description: string, status: Category) {
        ...
        this.item = item;
        this.dropZone = new ItemDropZone(
            `item-${item.id}`,
            this.view,
            false,
            item
    ...
    private toggleDescription(e: MouseEvent) {
        ...
        const descriptionButton = itemElement.querySelector(
            ".read-btn"
        ) as Element;
