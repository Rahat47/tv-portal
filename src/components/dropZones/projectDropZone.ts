...
export class ProjectDropZone extends DropZone {
    ...
    protected dropHandler(e: DragEvent) {
        ...
        const projectId = (e.dataTransfer as DataTransfer).getData(
            "text/plain"
        );
    ...
    private getProject(
        ...
        const projectContainerEle =
            projectDropZone1.closest(".project-container");
        ...
        const projectDropZone2 =
            projectContainerDropZonesArr[projectDropIndex - 1];
        const validDropZonesArr = dropZonesArr.filter(dropZone => {
            return (
                dropZone !== projectDropZone1 && dropZone !== projectDropZone2
            );
        });
